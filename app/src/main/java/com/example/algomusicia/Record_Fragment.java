...
public class Record_Fragment extends Fragment implements View.OnClickListener  {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        blurImageView = view.findViewById(R.id.bgblurrecord);
        ...
        switch (v.getId()) {
            ...
            case R.id.record_btn:
                if(isRecording) {
                    ...
                    recordBtn.setImageDrawable(getResources().getDrawable(R.drawable.ic_play_record, null));
                    isRecording = false;
                } else {
    ...
    private void startRecording() {
      ...
      String recordPath1 = Environment.getExternalStorageDirectory().getAbsolutePath()+"/Recordings";

        String recordPath = getActivity().getExternalFilesDir("/").getAbsolutePath();
        Log.d("Messi", recordPath);
